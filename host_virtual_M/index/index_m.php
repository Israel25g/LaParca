...
<body style="background-image: url('../../host_virtual_TI/images/Motivo2.png'); overflow: visible">
  ...
  try {
    ...
    $consultaSQL = "SELECT *, DATE(created_at)  fechaCreado,
       DATE(updated_at)  fechaActualizado FROM tickets_m";
  ...
  <div class="espacio">
    <div class="tabla-container">
      ...
      <div class="row">
        <div class="col-md-12">
          <h2><a href="../../helpdesk.php"><i class="bi bi-caret-left-fill arrow-back"></i></a>Tickets de Mantenimiento</h2>
          <div class="col-md-12">
          ...
          <div class="filtros pt-2">
            ...
            <div class="card text-start mt-1">
              <div class="card-body">
                <table id="tickMtable" class="display table p-3 bg-body-tertiary rounded compact hover cell-border" style="background-color: #fff;  margin-top: 2%">
                  <thead>
                    <tr class="table-warning">
                      ...
                      <th class="border end">Ultima actualización</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
                    ...
                    ?>
                        <tr>
                          <td class="text-break tabla-hover" data-bs-toggle="modal" data-bs-target="#modal_m<?= $fila["id"] ?>"><?php echo escapar($fila["id"]); ?></td>
                          <td class="text-break tabla-hover" data-bs-toggle="modal" data-bs-target="#modal_m<?= $fila["id"] ?>"><?php echo escapar($fila["nombrecompleto"]); ?></td>
                          <td class="text-break tabla-hover" data-bs-toggle="modal" data-bs-target="#modal_m<?= $fila["id"] ?>"><?php echo escapar($fila["ubicacion"]); ?></td>
                          <td class="text-break tabla-hover" data-bs-toggle="modal" data-bs-target="#modal_m<?= $fila["id"] ?>"><?php echo escapar($fila["descripcion"]); ?></td>
                          <td class="text-break tabla-hover" data-bs-toggle="modal" data-bs-target="#modal_m<?= $fila["id"] ?>"><?php echo escapar($fila["urgencia"]); ?></td>
                          <td class="text-break tabla-hover" data-bs-toggle="modal" data-bs-target="#modal_m<?= $fila["id"] ?>"><?php echo escapar($fila["respuesta"]); ?></td>
                          <td class="text-break tabla-hover" data-bs-toggle="modal" data-bs-target="#modal_m<?= $fila["id"] ?>"><?php echo escapar($fila["estado"]); ?></td>
                          <td class="text-break tabla-hover" data-bs-toggle="modal" data-bs-target="#modal_m<?= $fila["id"] ?>"><?php echo escapar($fila["fechaCreado"]); ?></td>
                          <td class="text-break tabla-hover" data-bs-toggle="modal" data-bs-target="#modal_m<?= $fila["id"] ?>"><?php echo escapar($fila["fechaActualizado"]); ?></td>
                            ...
                            <div
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                  ...
                                  if ($_SESSION['rol'] == 'Admin') {
                                  ?>
                                    <a class="btn btn-success" href="../indexAdmin/responder_m.php?id=<?= $fila["id"] ?>" style="color: white; text-decoration: none;">Responder</a>
                                  <?php
                                  }
                                  ?>
                                </div>
    ...
    <script>
      $(document).ready(function() {
        var table = $('#tickMtable').DataTable({
          language: {
