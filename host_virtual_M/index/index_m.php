  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <table id="tickMtable" class="table shadow-sm p-3 mb-5 bg-body-tertiary rounded table-striped">
          <thead>
            <tr>
              <th>TID</th>
              <th>Solicitante</th>
          ...
          <tbody>
            ...
            ?>
          </tbody> <!-- Aquí el cierre correcto de tbody -->
        </table>
      </div>
    </div>
  </div>
