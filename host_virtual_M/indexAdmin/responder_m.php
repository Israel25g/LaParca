...
if (isset($_POST['submit'])) {
    try {
        ...
        $consultaInfo = "SELECT * FROM tickets_m WHERE id = :id";
        ...
        $consultaSQL = "INSERT INTO tickets_m_r (estado, respuesta, nombrecompleto, descripcion, correo, ubicacion, urgencia, updated_at) 
        ...
        $consultaInfo = "SELECT correo, nombrecompleto FROM tickets_m WHERE id = :id";
        $consultaInfoStmt = $conexion->prepare($consultaInfo);
        $consultaInfoStmt->execute(['id' => $_GET['id']]);
        ...
        try {
            ...
            $mail->addCC('cecilio@iplgsc.com');  // Copia a un correo adicional si es necesario
            ...
            $mail->Body    = "
                ...
                <p>Atentamente,<br>El departamento de Mantenimiento<br><em>(No responder a este mensaje).</em></p>
            ";
...
<body style="margin: 0; padding: 0;background-image: url('../../images/Motivo2.png')!important; font-family: montserrat;">
    ...
    <?php if (isset($tickets) && $tickets) { ?>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <a class="btn btn-success mb-2" href="../index/index_m.php">Regresar al listado</a>
                    <div class="card text-start">
                        ...
                        <form method="post">
                            ...
                            <div class="card text-start">
                                ...
                                <input type="submit" name="submit" class="btn btn-primary mt-2" value="Responder">
                            </div>
                        </form>
                    </div>
                </div>
