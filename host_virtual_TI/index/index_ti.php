...
<body style="background-image: url('../../host_virtual_TI/images/Motivo2.png'); overflow: visible">
  ...
  try {
    ...
    $consultaSQL = "SELECT *, DATE(created_at)  fechaCreado,
       DATE(updated_at)  fechaActualizado FROM tickets";
    ...
    <div class="espacio">
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="col-md-12">
            <a href="crear_ti.php#disabledd" class="btn btn-success "><i class="bi bi-pen-fill"></i> Crear Ticket</a>
            <?php
                  ...
                  <tbody>
                    ...
                    ?>
                        <tr>
                          ...
                          <td class="text-break tabla-hover" data-bs-toggle="modal" data-bs-target="#login<?= $fila["id"] ?>"><?php echo escapar($fila["nombrecompleto"]); ?></td>
                          <td class="text-break tabla-hover" data-bs-toggle="modal" data-bs-target="#login<?= $fila["id"] ?>"><?php echo escapar($fila["ubicacion"]); ?></td>
                          <td class="text-break tabla-hover" data-bs-toggle="modal" data-bs-target="#login<?= $fila["id"] ?>"><?php echo escapar($fila["descripcion"]); ?></td>
                          <td class="text-break tabla-hover" data-bs-toggle="modal" data-bs-target="#login<?= $fila["id"] ?>"><?php echo escapar($fila["urgencia"]); ?></td>
                          <td class="text-break tabla-hover" data-bs-toggle="modal" data-bs-target="#login<?= $fila["id"] ?>"><?php echo escapar($fila["respuesta"]); ?></td>
                          <td class="text-break tabla-hover" data-bs-toggle="modal" data-bs-target="#login<?= $fila["id"] ?>"><?php echo escapar($fila["estado"]); ?></td>
                          <td class="text-break tabla-hover" data-bs-toggle="modal" data-bs-target="#login<?= $fila["id"] ?>"><?php echo escapar($fila["fechaCreado"]); ?></td>
                          <td class="text-break tabla-hover" data-bs-toggle="modal" data-bs-target="#login<?= $fila["id"] ?>"><?php echo escapar($fila["fechaActualizado"]); ?></td>
                            ...
                            <div
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                  ...
                                  ?>
                                    <a class="btn btn-success" href="../indexAdmin/responder_ti.php?id=<?= $fila["id"] ?>" style="color: white; text-decoration: none;">Responder</a>
                                  <?php
                                  }
                                  ?>
                                </div>
