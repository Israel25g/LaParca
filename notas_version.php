<div class="accordion acordion-flush" id="notas_version">
    <div class="accordion-item">
        <div class="accordion-header">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#notas_version_1" aria-expanded="false" aria-controls="notas_version_1">
                <h2>Notas de la versión 1.0</h2>
            </button>
        </div>
