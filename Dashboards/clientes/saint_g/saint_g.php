...
#grafico-pastel1 {
    ...
    <div class="bloque_d border border-warning border-5" id="grafico1" style="height: 125px; width: 160px; margin-top: 150px!important; margin: left 200px !important; ">
        <img loading="lazy" class="img_helpdesk" id="logo-stg" src="../../../images/Saint-Gobain.png" style="height: 125px; width: 160px;" alt="">
    </div>
