...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>
    ...
    <!-- Header -->
    <div class="Header">
    <h1 style=" color: white; margin-left:40%; display: flex;">Sistema de Tickets</h1>
    ...
    <!-- Navbar -->
    <div class="container ">
  <nav class="navbar navbar-expand-lg bg-body-succ shadow-sm p-3 mb-5 bg-body-tertiary rounded-5 rounded-top-0 bg-success-subtle ">
        ...
        <a class="btn btn-outline-success link-body-emphasis" href="#">Daily plan</a>
