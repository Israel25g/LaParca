...
<body style="background-image:url('../host_virtual_TI/images/Motivo2.png');margin: 0;padding: 0; font-family:montserrat;">
  <div style="margin-top: 90px;" >
    ...
    <!-- <div class="container-nav" style="margin-top: -60px; margin-left: 36% ;position:fixed; z-index: 999">
         <div class="navbarr">
    ...
    <div class="container" style="margin-top: 150px">
      <div class="row">
        <div class="col-md-12">
          <h3 class="mt-4">Ingrese los datos para crear Daily plan de Picking</h3>
          <a class="btn btn-success btn-md" href="../daily_plan/tabla_pk.php" style="margin-top: 2%">Volver a la tabla</a>
          <hr>
          <form method="post">
    <div class="form-row">
