      ...
      <body style="background-image:url('../host_virtual_TI/images/Motivo2.png');margin: 0;padding: 0; font-family:montserrat;">
        <div class="espacio">
          ...
          <div class="tabla-container">
            <div class="row">
              <div class="col-md-12">
                <h2 class="mt-3 nombre-tabla" style="margin: 10px;" ><a href="../daily_plan/index_DP.php"><i class="bi bi-caret-left-fill arrow-back"></i></a>Picking</h2>
                <button class="btn btn-success ingreso-data dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"  style="margin-bottom: 10px;">Ingresar datos de Picking</button>
                ...
                <br/>
                <table id="tablaPicking" class="display table shadow p-3 mb-5 bg-body-tertiary rounded table-striped border" style="background-color: #fff;  margin-top: 2%">
                  <thead>
                      <tr>
