...
<?php if ($error): ?>
      ...
      <?php endif; ?>
          ...
          <div class="container">
              <div class="row">
                <div class="col-md-12">
                  <h2 class="mt-3" style="margin-bottom: 10px;">Picking</h2>
                 
                      <a class="btn btn-success" style="margin-left: 0%; margin-bottom: 10px" href="../daily_plan/formulario_pk.php">Ingresar datos a Piking</a>
