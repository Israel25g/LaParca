...
<?php if ($error): ?>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-13"  style=" margin-top: 10%">
        <h2 class="mt-3">Export</h2>
        <a class="btn btn-success" style="margin-left: 0%;margin-bottom:10px;  margin-top: 0%" href="../daily_plan/formulario_ex.php">Ingresar datos de Export</a>
        <table id="tablaExport" class="display table shadow p-3 mb-5 bg-body-tertiary rounded table-striped border" style="background-color:#fff; margin-top: 1%">
          <thead>
            <tr>
