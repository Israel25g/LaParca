  ...
  <body style="background-image:url('../host_virtual_TI/images/Motivo2.png');margin: 0;padding: 0; font-family:montserrat;">
    <div style="margin-top: 90px;">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="mt-3" style="margin-bottom: 10px;">Import</h2>
            <a class="btn btn-success" style="margin-left: 0%;margin-bottom: 10px;" href="../daily_plan/formulario_im.php">Ingresar datos de Import</a>
