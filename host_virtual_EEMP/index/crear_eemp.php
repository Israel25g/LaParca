...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $mail->addAddress('israel@iplgsc.com'); 
        $mail->addAddress('alcibiades@iplgsc.com');

        $mail->isHTML(false);
        $mail->Subject = 'Confirmación de recepción del ticket';
        $mail->Body = "Hola " . $tickets['nombrecompleto'] . ",\n\n" .
            "Gracias por contactarnos. Aquí están los datos que nos suministraste:\n\n" .
        ...
        <div class="fondo-tickets">
            <form method="post" onsubmit="handleSubmit(event)">
                <h2 class="form-tickets"><a href="../../host_virtual_EEMP/index/index_eemp.php"><i class="bi bi-caret-left-fill arrow-back"></i></a>Ingrese los datos para crear el Ticket</h2>
                        <div style="max-width: auto;"><a class="btn btn-success btn-lg" href="../index/index_eemp.php">Volver al listado</a></div>
                        <hr>
